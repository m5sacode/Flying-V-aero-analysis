...
plt.figure(figsize=(8, 6))
plt.plot(betas_alpha_0, total_cls_alpha_0, 'ro-', label="Alpha 0 Csf (\u03B1=0°)")
plt.plot(betas_alpha_0, total_cls_alpha_10, 'bo-', label="Alpha 10 Csf (\u03B1=0°)")
plt.xlabel("Sideslip Angle (β°)")
plt.ylabel("Side Force Coefficient")
# plt.title(" vs. Sideslip Angle")
plt.grid(True)
plt.legend(fontsize = 15)
plt.show()